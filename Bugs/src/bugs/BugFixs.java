...
public class BugFixs {
    ...
    private static ArrayList<Integer> optionsSelection() {
...
//                        System.out.println(expenses+"\n");
    ...
    private static void searchExpenses(ArrayList<Integer> arrayList) {
        ...
        if(result >= 0) {
        	System.out.println("Yes.. This expense is present in your expense list");
    ...
    public static ArrayList addExpenses(ArrayList<Integer> arrayList) {
    	System.out.println("Enter the value to add your Expense: \n");
